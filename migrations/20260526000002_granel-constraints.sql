-- ============================================================
-- PAuleam ERP — Migración: Restricciones para PRODUCTO_A_GRANEL
-- Parte 2/2 — Depende de 20260526000000 (PRODUCTO_A_GRANEL ya committed).
-- Actualiza: trigger de ingreso protegido + función de alertas de stock.
-- ============================================================

-- 1. Actualizar trigger: restricciones de ingreso por tipo
--    PRODUCTO_A_GRANEL: solo PRODUCCION o AJUSTE pueden crear INGRESO
--    PRODUCTO_TERMINADO: PRODUCCION, EMPAQUE o AJUSTE (backward compat)
...
-- El trigger ya existe (creado en 20260525000099), solo se reemplaza la función.
-- Si no existiera el trigger, descomentar:
...
-- 2. Actualizar función de alertas de stock mínimo:
--    Incluir PRODUCTO_A_GRANEL (granel interno, importante monitorear para alimentar el empaque)
