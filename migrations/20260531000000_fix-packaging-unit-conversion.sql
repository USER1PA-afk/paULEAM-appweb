-- Fix: packaging trigger convertía bulk_qty_per_unit a kg cuando bulk_unit no es kg/l
-- El inventario siempre guarda en la unidad base del producto (kg).
-- Si la plantilla tiene bulk_unit = 'g' o 'gs', hay que dividir entre 1000.
-- Si bulk_unit = 'mg', dividir entre 1_000_000. Si 'lb' o 'libra', × 0.453592.
...
-- Recrear el trigger de completar empaque con conversión de unidades
...
-- Asegurarse de que el trigger apunte a la función actualizada
