...
CREATE INDEX idx_product_suppliers_primary  ON public.product_suppliers(product_id, is_primary);
...
CREATE INDEX idx_ledger_supplier ON public.inventory_ledger(supplier_id);
