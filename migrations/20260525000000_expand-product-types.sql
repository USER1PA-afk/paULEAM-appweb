-- ============================================================
-- PAuleam ERP — Migración: Ampliar taxonomía de tipos de producto
-- ============================================================
-- Añade: INSUMO, ENVASE_EMPAQUE, OTRO al enum product_type
-- Añade: min_stock_alert, cost_per_unit a products
-- Regla: product_type no puede cambiar si ya tiene movimientos
-- ============================================================

-- 1. Expandir el ENUM (ADD VALUE es idempotente en PostgreSQL 12+)
...
-- 4. Trigger: solo PRODUCCION/EMPAQUE puede generar INGRESO para PRODUCTO_TERMINADO
...
-- 5. Función auxiliar para alerta de stock mínimo
